      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div id="comoMostrar_documentos" class="text-center col-xs-12">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <?php
            $persona = $consulta->buscar($_POST['perfil'], array('id'), '*', false, array('id'=>$_POST['usuario']));
            $ficherosSubidos = $consulta->buscar('gestionFicheros', array('email', 'perfil', 'accion'), '*', true, array('email'=>$persona['email']), 'AND', 'fecha', 'DESC');
            $total = count($ficherosSubidos);
            $ficherosMostrar = $consulta->get_resultadosPaginacion('gestionFicheros', $total, 'verPerfil');?>
            ...
            for ($i=1; $i <= $total_paginas; $i++) {
                echo "<li><a style='cursor:pointer;' onclick='return verSubidas" . "($mostrar,$i);" . "'>" . $i . "</a></li>";
            };
            ?>
            </ul>
          </div>
          <?php if (!empty($ficherosMostrar)): ?>
            <div class="form form-group form-inline col-xs-12 col-sm-12 col-md-12">
              ...
              echo $mostrar?> style="width:5em;" onchange="return verSubidas(this.value,<?php echo $pagina;?>);" min=1>
            </div>
          <?php endif; ?>
        </div>
        <?php if (empty($ficherosMostrar)): ?>
              ...
              <div class="panel-heading">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-center">
                    <p><?php
                    echo $autor['nombre'] . " - " . $perfil; ?><br><p style="color:rgba(0, 0, 0, 0.6);"><?php echo $autor['grado']; ?></p></p>
                  </div>
                    ...
                    <div class="panel-body doc_subido">
                      <div class="row">
                        <div class="col-xs-12 col-sm-1">
                          <?php
                          session_start();
                          if (!isset($_SESSION["conectado"]) && !isset($_SESSION["online"])): ?>
                          ...
                          <?php else: ?>
                            ...
                            echo '"return descargar(' . "'" . $row['id'] . "');" . '"'; ?> download>
                          <?php endif; ?>
